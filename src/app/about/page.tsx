...
const About = () => {
  return (
    <div>
      <section className='about' style={{ backgroundImage: "url(/images/aboutbg.jpg)"}}>
        <div className='about-center'>
            <h2 className='fade-in'>About Us</h2>
            <p>Welcome to the world of watches, where time meets elegance and 
                innovation. In this captivating realm, each timepiece tells a 
                  ...
                  Whether you`re a collector seeking rare and exquisite pieces
                   or someone looking for a reliable everyday companion, the
                    ...
                    artistry of horology, where tradition and modernity
                     coexist, and discover a timepiece that resonates with 
                     your style and needs. Welcome to a world where every 
                     second counts, and every watch is a masterpiece.</p>
        </div>
      </section>
    </div>
  )
